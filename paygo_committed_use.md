...
1. Consult with an [{{site.data.keyword.cloud_notm}} Sales](https://www.ibm.com/solutions/cloud?contactmodule){: external} representative.
1. {{site.data.keyword.cloud_notm}} Sales directs you to the [registration page](https://cloud.ibm.com/registration/sales){: external}. Enter the required information.
...
To view the discounts that are applied to your commitment in the {{site.data.keyword.cloud_notm}} console, go to **Manage** > **Billing and usage** > **Commitments** > **Enterprise Savings Plan**. In the discounts section, use the table to view your active discounts.

For more information about product-level discounts through your Enterprise Savings Plan, work with [{{site.data.keyword.cloud_notm}} Sales](https://www.ibm.com/solutions/cloud?contactmodule){: external}.
