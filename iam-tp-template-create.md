...
1. Enter a name and description for the enterprise-managed trusted profile that describes its purpose for child account users, and be sure to include a list of actions available for this trusted profile in the description.
