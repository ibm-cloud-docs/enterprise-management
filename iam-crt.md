...
In enterprises with multiple child accounts, manually configuring access restrictions and permissions across accounts can be complex and time-consuming. To help ensure consistent security and compliance, enterprise admins can centrally create and assign custom roles to subaccounts, enforcing the principle of least privilege. This capability simplifies role management and helps maintain uniform governance across your organization's accounts.
{: shortdesc}
